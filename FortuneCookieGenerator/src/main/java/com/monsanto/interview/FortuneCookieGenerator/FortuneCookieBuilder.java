...
public class FortuneCookieBuilder {
    ...
    /**
     * Added cleanAll method calling.
     * It cleans all the values setted before.
     * It allows to change the values.
     * @return
     */
    FortuneCookieBuilder cleanAll() {
    	this.client = NOT_DEFINED;
    	this.company = NOT_DEFINED;
    	this.quote = NOT_DEFINED;
    	return this;
    }
